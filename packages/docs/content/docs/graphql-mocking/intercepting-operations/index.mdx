...
Every GraphQL handler consists of an **identifier** and a response config. The config can be a static value, a resolver function, a generator function, or `polling()`. Pass matchers and response settings in the optional third argument.
