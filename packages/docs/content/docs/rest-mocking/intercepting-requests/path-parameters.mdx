...
If you want to return different responses based on params values, use `params` in the route matcher.

mdx## Parameters In Matchers
...
const route = rest.get<{ params: { id: string } }>('/users/:id', {
  match: {
    params: {
      id: '1'
    }
