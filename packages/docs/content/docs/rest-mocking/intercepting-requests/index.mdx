...
Every REST route consists of a path selector and a response config. The config can be a static value, a resolver function, a generator function, `file()`, or `polling()`. Pass matchers and response settings in the optional third argument.
